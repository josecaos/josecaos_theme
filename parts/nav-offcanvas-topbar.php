...
<div class="top-bar fondo_naranja_o" id="top-bar-menu">
	<div class="small-8 columns top-bar-left float-left fondo_transparente">
	...
	<div class="small-4 columns top-bar-right show-for-medium">
		<div class="small-2 contacto">
			...
			<a data-open="offCanvasRight" ><i class="fa fa-envelope"></i>WTF!</a> <!-- data-toggle="off-canvas" -->
		</div>
		 <!-- <? joints_top_nav(); ?> 	  -->
	...
	<div class="small-4 columns top-bar-right float-right show-for-small-only">
		<ul class="small-3 menu fondo_transparente">
			<!-- <li><a class="menu-icon" type="button" data-open="offCanvasLeft"></a></li> -->
			<li><a data-open="offCanvasLeft" class="color_gris_c"></a><i class="fa fa-reorder"></i></li> <!-- data-toggle="off-canvas" -->
		</ul>
	</div>
</div>
